...
jQuery(document).ready(function () {
    ...
    var tipo = null;
    var nombre = null;
    tipo = getElement(form0, 'tipo_pecuniario');
    nombre = getElement(form0, 'nombre_pecuniario');
    autoNameFromDataList(tipo, nombre.id, null);
    document.getElementById("anualidad_pecuniario").value=new Date().getFullYear();
});
