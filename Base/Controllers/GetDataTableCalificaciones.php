...
if ($session->hasLogin() && $_REQUEST !== null && isset($_REQUEST)) {
    ...
    $sql2 = "SELECT @rownum := @rownum +1 AS rownum, "
            ...
            . " ROUND(IFNULL((IFNULL(C.p1_nd_calificacion,0)*".$porcP1." + IFNULL(C.p2_nd_calificacion,0)*".$porcP2." + IFNULL(C.p3_nd_calificacion,0)*".$porcP3." + IFNULL(C.p4_nd_calificacion,0)*".$porcP4."),'0'),1) as def, "
